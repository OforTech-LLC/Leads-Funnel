...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_COGNITO_DOMAIN_DEV: process.env.NEXT_PUBLIC_COGNITO_DOMAIN_DEV,
    NEXT_PUBLIC_COGNITO_CLIENT_ID_DEV: process.env.NEXT_PUBLIC_COGNITO_CLIENT_ID_DEV,
    NEXT_PUBLIC_COGNITO_DOMAIN_PROD: process.env.NEXT_PUBLIC_COGNITO_DOMAIN_PROD,
    NEXT_PUBLIC_COGNITO_CLIENT_ID_PROD: process.env.NEXT_PUBLIC_COGNITO_CLIENT_ID_PROD,
