...
import type { SlackMessage, SlackBlock, LeadInfo } from './types.js';
 ...
 */
export async function sendSlackMessage(webhookUrl: string, payload: SlackMessage): Promise<void> {
 ...
 */
export function formatLeadNotification(lead: LeadInfo): SlackMessage {
