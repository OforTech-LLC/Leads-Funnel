 ...
 */
export function getWindowBucket(windowMinutes: number): string {
  const now = new Date();
 ...
 */
export function getRateLimitTtl(windowMinutes: number): number {
 ...
 */
export function getIdempotencyTtl(ttlHours: number): number {
