 ...
 */
export function createCalendarProvider(config: CalendarConfig): CalendarProviderInterface {
  switch (config.provider) {
    ...
    case 'apple':
      return new AppleCalendarProvider(
        config.caldavUrl || 'https://caldav.icloud.com',
        '', // username would come from stored credentials
 ...
 */
export function getSupportedProviders(): CalendarProvider[] {
