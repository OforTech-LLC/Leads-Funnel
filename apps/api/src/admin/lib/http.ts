 ...
 * 200 OK response
 */
export function ok<T>(data: T, requestOrigin?: string): APIGatewayProxyResultV2 {
 ...
 */
export function notFound(message: string, requestOrigin?: string): APIGatewayProxyResultV2 {
  return buildResponse(
