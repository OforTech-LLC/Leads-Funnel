...
async function runTests() {
    ...
    try {
        ...
        if (typeof result1 === 'object' && 'statusCode' in result1) {
            ...
            console.log('Response:', result1.body ? JSON.parse(result1.body) : null);
        }
        else {
    ...
    try {
        ...
        if (typeof result2 === 'object' && 'statusCode' in result2) {
            ...
            console.log('Response:', result2.body ? JSON.parse(result2.body) : null);
        }
        else {
    ...
    try {
        ...
        if (typeof result3 === 'object' && 'statusCode' in result3) {
            ...
            console.log('Response:', result3.body ? JSON.parse(result3.body) : null);
        }
        else {
