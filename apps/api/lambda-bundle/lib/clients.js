 ...
 */
function createFastRequestHandler() {
    return new NodeHttpHandler({
        httpsAgent: keepAliveHttpsAgent,
        httpAgent: keepAliveHttpAgent,
 ...
 */
export function getDocClient(region) {
    if (!_docClient) {
 ...
 * @param region - Optional override; defaults to AWS_REGION env var
 */
export function getSsmClient(region) {
    if (!_ssmClient) {
 ...
 * @param region - Optional override; defaults to AWS_REGION env var
 */
export function getSesClient(region) {
    if (!_sesClient) {
 ...
 * @param region - Optional override; defaults to AWS_REGION env var
 */
export function getSnsClient(region) {
    if (!_snsClient) {
...
// ---------------------------------------------------------------------------
let _secretsManagerClient = null;
/**
 * Return (or create) the shared Secrets Manager Client.
 *
 * @param region - Optional override; defaults to AWS_REGION env var
 */
export function getSecretsManagerClient(region) {
 ...
 */
export async function getSecretValue(secretArn, region) {
    // Check cache first
