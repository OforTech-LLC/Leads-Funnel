 ...
 */
export async function authenticatePortal(event) {
    ...
    const orgIdsRaw = claims['custom:orgIds'];
    const primaryOrgId = claims['custom:primaryOrgId'];
    if (!userId) {
 ...
 */
export function checkLeadAccess(identity, lead) {
...
//# sourceMappingURL=portal-auth.js.map