 ...
 */
export function hmacSha256(input, key) {
 ...
 * ```
 */
export function hashEmailWithSalt(email, salt) {
 ...
 */
export function generateIdempotencyKey(normalizedEmail, funnelId, content) {
 ...
 * ```
 */
export function truncatedHash(input, length = 12) {
