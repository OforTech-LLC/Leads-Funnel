# Life Insurance Landing Page Patterns

## Reference Landing Pages

1. **Ethos Life Insurance** - https://www.ethos.com/
2. **Ladder Life Insurance** - https://www.ladderlife.com/
3. **Haven Life Insurance** - https://havenlife.com/
4. **Bestow Life Insurance** - https://www.bestow.com/
5. **Fabric Life Insurance** - https://meetfabric.com/
6. **Lemonade Life Insurance** - https://www.lemonade.com/life
7. **PolicyGenius** - https://www.policygenius.com/life-insurance/
8. **Quotacy** - https://www.quotacy.com/
9. **SelectQuote** - https://www.selectquote.com/life-insurance/
10. **AIG Direct** - https://www.aigdirect.com/life-insurance
...
- **Protection-focused**: "Protect Your Family's Future Today"
...
4. **Coverage amount preview** (e.g., "$500K coverage from $16/month")
5. **Time commitment callout** ("Takes just 5-10 minutes")
...
- Calculator or interactive elements visible
...
- **Data security messaging** near form ("Your information is encrypted")
...
1. **Hero Section**
   ...
   - Quick quote CTA or mini-form
   - Trust indicator (rating, backed by)

2. **Value Proposition Strip**
   - 3-4 benefit icons with short descriptions
   - "No medical exam" | "Fast approval" | "Affordable rates"

3. **How It Works**
   - 3-step process visualization
   - Step 1: Get a quote (2 min)
   - Step 2: Apply online (10 min)
   - Step 3: Get covered (instant to 24hrs)

4. **Coverage Calculator/Interactive Tool**
   - Slider for coverage amount
   - Monthly cost preview
   - Term length options

5. **Why Choose Us**
   - Differentiators from traditional insurance
   - Technology benefits
...
8. **Final CTA Section**
   ...
   - Primary CTA button
   - Contact alternatives (phone, chat)
...
### High-Converting Life Insurance Landing Page Formula

```
┌─────────────────────────────────────────────────────────────┐
│  HERO SECTION                                                │
│  ├─ Clear headline: Speed + Simplicity + Value              │
│  ├─ Subheadline: No exam, fast approval, trusted carrier    │
│  ├─ Mini-form or prominent CTA button                       │
│  ├─ Trust badge (A+ rated, X families protected)            │
│  └─ Hero image: Family/protection theme                     │
├─────────────────────────────────────────────────────────────┤
│  VALUE STRIP (3-4 icons)                                    │
│  ├─ No Medical Exam                                         │
│  ├─ Coverage in Minutes                                     │
│  ├─ Rates from $X/month                                     │
│  └─ Cancel Anytime                                          │
...
│  ├─ Address complexity objection                            │
│  ├─ Address trust objection                                 │
│  └─ Address coverage amount question                        │
├─────────────────────────────────────────────────────────────┤
│  FINAL CTA SECTION                                          │
│  ├─ Reinforced headline                                     │
│  ├─ Primary CTA button                                      │
