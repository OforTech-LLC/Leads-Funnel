# Dermatology Landing Page Patterns

## Reference Landing Pages

1. **Instapage Dermatology Template**
   - https://instapage.com/en/template/landing-page-template-for-dermatologists

2. **Instapage Dermatology Clinic Builder**
   - https://instapage.com/en/functionality/build-your-landing-page-for-dermatology-clinics

3. **Codeless Website - Dermatology Web Design Examples**
   - https://mycodelesswebsite.com/dermatology-web-design/

4. **Glacial Dermatology Website Design**
   - https://www.glacial.com/medical-website-design/dermatology-website-design/

5. **Flamingo Agency - Dermatology Websites**
   - https://www.flamingoagency.com/dermatology-website-design/

6. **Seahawk Media - Dermatologist Website Examples**
   - https://seahawkmedia.com/design/dermatologist-websites/

7. **Brand Glow Up - Dermatologist Website Examples**
   - https://www.brandglowup.com/dermatologist-website-examples-inspirations/

8. **CyberOptik - Best Dermatology Website Designs**
   - https://www.cyberoptik.net/blog/best-dermatology-website-designs/

9. **Officite - Dermatology Website Design Ideas**
   - https://www.officite.com/9-best-dermatology-website-design-ideas/

10. **Ovation Themes - Dermatology Website Design Tips**
    - https://www.ovationthemes.com/blogs/wp-themes/dermatology-website-design
...
- **Outcome-based**: "Reveal Your Best Skin"
...
- Modern clinic interior highlighting cleanliness
- Diverse patient imagery showing healthy skin
...
5. Service Type (Medical/Cosmetic)
6. Preferred Location (if multi-office)
...
4. How long have you had this concern?
...
- "Your privacy is protected" reassurance
...
- Medical school/residency affiliations
...
- Condition/treatment labeled
- "Real Patient Results" disclaimer
...
1. **Hero Section**
   - Clear, patient-focused headline
   - Professional subheadline
   - High-quality imagery
   - Appointment request form or CTA
   - Trust badge (board certified, reviews)
...
4. **Before/After Gallery**
   - Organized by condition/treatment
   - 4-6 best transformation examples
   - Professional, consistent photography
   - CTA to view full gallery

5. **Meet Our Team**
   - Lead dermatologist(s) photo
   - Credentials summary
   - Specialization areas
   - Approach to patient care
   - Support staff highlights

6. **Patient Testimonials**
   - Video testimonial (recommended)
   - 3-4 written reviews
   - Variety of treatments represented
   - Patient photos when permitted

7. **Insurance & Pricing**
   - Insurance plans accepted
   - Self-pay options
   - Financing for cosmetic services
...
10. **Final CTA Section**
    - Compelling headline
    - Appointment form or call button
...
- Combination approaches for faster results
...
- [ ] Trust indicator (certification/reviews)
