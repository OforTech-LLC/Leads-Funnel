# Orthodontist Landing Page Patterns
...
2. **Battle Orthodontics Landing Page Example**
   - https://www.convertflow.com/call-to-action/battle-orthodontics-landing-page

3. **Landingi Dentist Examples**
   - https://landingi.com/landing-page/dentist-examples/

4. **Greenwich Dental Health (Invisalign)**
   - Referenced at https://www.convertflow.com/campaigns/dental-landing-pages

5. **Apexure Dentist Landing Page Guide**
   - https://www.apexure.com/dentist-landing-page/

6. **Wishpond Dental Landing Page Guide**
   - https://www.wishpond.com/dental-marketing/dentists-landing-page/

7. **Gravity Dental Complete Guide**
   - https://gravitydental.com/the-complete-guide-to-landing-pages-for-dentists/

8. **Titan Web Agency Dental Landing Pages**
   - https://blog.titanwebagency.com/dental-landing-page-google-ads

9. **Smile Tactics Best Dental Strategies**
   - https://smiletactics.com/blog/dental-landing-page/

10. **InvisiblePPC Mini Guide**
    - https://invisibleppc.com/blog/marketing/mini-guide-to-a-perfect-landing-page-for-dentists
...
- **Problem-solution**: "Tired of Hiding Your Smile?"
...
- Treatment device imagery (Invisalign trays, clear braces)
...
- Trust badge (Google rating, years in practice)
...
4. **Testimonial hero**: Patient story front and center
...
2. Phone Number
3. Email Address
4. Treatment Interest (dropdown: Invisalign, Braces, Not Sure)
5. Best Time to Call
...
2. Phone Number
3. Email
4. Is this for you or your child?
5. Current dental concern
...
- Add "We'll never share your information" text
...
- Invisalign Preferred/Elite Provider status
...
- "X,XXX Smiles Transformed" counter
...
1. **Hero Section**
   - Headline addressing patient desire
   - Supporting subheadline
   - Hero image (smiling patient or transformation)
...
3. **Treatment Options Overview**
   ...
   - Traditional braces
   - Clear braces
   - Brief descriptions with images
   - "Learn more" or direct CTA for each

4. **Before/After Gallery**
   - 4-6 best transformations
   - Variety of cases (crowding, gaps, bite issues)
   - Treatment type labeled
   - CTA to see full gallery
...
7. **Patient Testimonials**
   ...
   - 2-3 written testimonials with photos
   - Mix of adult and teen patients
...
- **Orange/Coral**: Warm, friendly, action-oriented CTAs
- Avoid: Dark, clinical-feeling designs
