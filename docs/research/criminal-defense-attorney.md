# Criminal Defense Attorney Landing Page Patterns
...
4. **Instapage Criminal Defense Template** - Industry-specific conversion template
5. **NACDL (National Association of Criminal Defense Lawyers)** - Professional resource
6. **Shouse California Law Group** - https://www.shouselaw.com/ - Educational content approach
7. **Brill Legal Group** - https://www.newyorkcriminaldefenseattorney.com/ - Urgent response focus
...
- [Savvy Law Firm Marketing - Criminal Defense Landing Pages](https://savvylawfirmmarketing.com/blog/criminal-defense-landing-pages/)
- [NACDL - Sample Client Intake Form](https://www.nacdl.org/Document/SampleClientIntakeForm)
...
- **Shield/Protection Symbolism**: Visual representation of defense
...
4. **Fast Response**: "Speak to an Attorney in Minutes"
5. **Free Consultation**: "No Obligation. 100% Confidential."
...
4. **Exit Intent**: "Get help before you go" popup
...
- Real-time attorney availability indicator
- "X cases resolved this month"
...
- Phone Number (required)
- Email (required)
- Type of Charge (dropdown: DUI, Drug Offense, Assault, Theft, Other)
- Best Time to Call
```
...
- Email
- Type of Charge
- Arrest Date (approximate)
- Have you been formally charged? (Yes/No/Not Sure)
- Are you currently in custody? (Yes/No)
...
- Optional "custody status" helps triage
...
- Appellate success: "X Convictions Overturned"
...
- "Hundreds of Trials" experience
- "Will Fight for You" messaging
...
1. HERO SECTION
   ...
   - Click-to-call + short form
   - Key credentials (former prosecutor, etc.)
...
7. ATTORNEY PROFILES
   ...
   - Former prosecutor status
   - Trial experience
   - Professional headshots

8. TESTIMONIALS
   - Video preferred (with consent)
   - Anonymized written reviews
   - Star ratings
   - Outcome mentions
...
4. How much does a criminal defense attorney cost?
5. Can charges be dropped or reduced?
6. What if I've already spoken to police?
7. Will this go on my record?
8. How long will my case take?
9. Do I need a lawyer for a first offense?
10. What are my rights during an arrest?
...
[HERO: 50% viewport, dark/serious tone]
- Urgent headline ("Arrested? Act Now.")
- Subheadline with key differentiator
- Short form (name, phone, charge type) OR call button
- "Former Prosecutor" badge
- "24/7 Available" indicator

[URGENCY BAR: Contrasting color]
- Time-sensitive messaging
- Response time promise
- Confidentiality assurance

[OFFENSE TYPE GRID: Card layout]
- DUI/DWI
- Drug Charges
- Assault
- Theft
...
[WHY US: 3-4 key differentiators]
...
- OR client testimonial (with consent)

[CASE RESULTS]
- Featured dismissals
- Charge reductions
- Organized by offense
- Required disclaimers

[ATTORNEY TEAM]
- Professional photos
- Credentials displayed
- Trial experience noted
...
[FINAL CTA: Full-width, urgent tone]
...
- Fast page load (stress situation)
