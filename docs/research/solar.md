# Solar Landing Page Patterns Research
...
- **ROI-Focused**: "Start Saving $XXX/Month on Your Electric Bill"
...
4. **After incentives section** - When financial benefits are clear
5. **Sticky bar** - Always accessible
...
- "$1,000 Off Installation - This Month Only"
...
- Zip code helps determine service area and incentives
- Monthly bill helps with savings calculation
...
- Star ratings from Google/Yelp/SolarReviews
- Video testimonials
...
1. **Hero Section**
   ...
   - Hero image (home with solar)
   - Trust bar (installations completed, certifications)

2. **Savings Calculator** (High-converting element)
...
3. **How Solar Works** (Educational)
   ...
   - Visual diagram
   - Address "is this complicated?" concern
...
5. **Incentives Section** (Critical for solar)
   - Federal tax credit (30%)
   - State incentives
   - Utility rebates
   - Financing options
...
7. **Process/Timeline**
   - Consultation > Design > Permits > Install > Activation
   - Set expectations (typically 1-3 months)

8. **Testimonials/Case Studies**
   - Customer reviews with savings data
   - Before/after electric bills
   - Video testimonials

9. **FAQ Section**
   - 7-10 common questions
   - Address ROI, timeline, roof concerns
...
3. How Solar Works (educational)
4. Benefits (financial, environmental)
...
4. **Urgency**: Incentive deadlines, rising electricity rates
5. **Risk Reversal**: Free quote, no-obligation
...
- Localized headlines resonate better
