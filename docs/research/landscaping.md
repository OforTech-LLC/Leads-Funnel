# Landscaping Landing Page Patterns Research
...
10. **Southview Design** - Real-world example with portfolio gallery and press articles
11. **Silverstone Landscaping** - Real-world example with before/after images and testimonials
12. **Earthworks Landscaping** - Real-world example with large portfolio and strong CTAs
...
- **Benefit-Driven**: "Beautiful Landscapes That Increase Your Home's Value"
...
4. **Sticky bar** - Mobile-optimized contact option
...
- "$500 Off Projects Booked This Month"
...
- Consider landscape icon or leaf icon
...
2. Phone Number
3. Email
4. Project Type (Lawn Care, Hardscaping, Planting, Full Landscape Design, Maintenance)
...
4. Address/Zip Code
5. Project Type
6. Project Size (Small/Medium/Large)
...
- "Schedule Your Free Consultation" as button text
- Privacy assurance below form
...
1. **Hero Section**
   ...
   - Trust bar (ratings, years in business, award badges)

2. **Services Section**
   - Service cards by category
   - Landscape design, hardscaping, planting, lawn care, maintenance
   - Brief descriptions with "Learn More" links

3. **Portfolio/Gallery Section** (Critical for landscaping)
...
5. **How It Works**
   ...
   - Consultation > Design > Installation > Enjoy
   - Sets expectations
...
7. **Service Areas**
   - Map or neighborhood list
   - Local presence emphasized

8. **FAQ Section**
   - 5-7 common questions
   - Pricing, timeline, process questions
...
10. **Footer**
    - Contact information
    - Service links
    - Social media (Instagram important for visual portfolio)
    - Legal pages
...
- What plants work best in [region]?
...
2. Phone (required)
3. Email (required)
4. Project Type (dropdown - required)
...
4. **Value**: Home value increase messaging, ROI
5. **Process**: Clear "How It Works" section reduces anxiety
...
- Instagram feed integration can showcase ongoing work
