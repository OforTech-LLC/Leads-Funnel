# Immigration Attorney Landing Page Patterns
...
6. **Divi Immigration Layout Pack** - Template example with structured sections
7. **Visaho Template** - Multilingual-ready visa consultant template
...
- [FirmPilot - SEO for Immigration Attorneys](https://firmpilot.com/blog/seo-for-immigration-attorneys/)
- [eimmigration - Immigration Lead Generation](https://get.eimmigration.com/blog/immigration-law-firm-leads)
...
- **Document Success**: Green card, visa approval imagery
...
4. **AILA Membership**: "Member, American Immigration Lawyers Association"
5. **Success Rate**: "97% Approval Rate on Family-Based Petitions"
...
4. **After Trust Section**: "Start Your Journey"
...
- Real-time consultation availability indicator
...
- Service Needed (dropdown: Family, Work Visa, Green Card, Citizenship, Deportation Defense)
- Preferred Language
```
...
- Email
- Phone
- Current Immigration Status (dropdown)
- Visa Type Interested In
- Do you have a sponsor/employer? (Yes/No)
...
- Optional detailed fields for self-qualification
- Clearly state confidentiality
- Include WhatsApp as contact option
...
- Third-party ratings (Avvo, Martindale-Hubbell)
...
- Display official AILA member badge
...
1. HERO SECTION
   ...
   - AILA/credential badges

2. LANGUAGE BAR
   - Flag icons with language names
   - "We serve clients in X languages"
...
5. HOW WE HELP (Process)
   - Step 1: Free Consultation
   - Step 2: Document Preparation
   - Step 3: Application Filing
   - Step 4: Case Tracking
   - Step 5: Approval Support

6. SUCCESS STORIES
   - Case studies by visa type
   - Client testimonials (with photos)
   - Country of origin diversity

7. ATTORNEY TEAM
   - Photos showing diversity
   - Languages spoken
   - Immigration specializations
   - Personal immigration stories (if applicable)

8. RESOURCES SECTION
   - Free guides by visa type
   - FAQ
...
4. Can you help if I've been denied before?
5. What's the difference between a green card and citizenship?
6. Can I work while my application is pending?
7. What happens if my visa expires?
8. Do you handle deportation defense?
...
- Service focus subheadline
- Lead form (4-5 fields) OR CTA button
- AILA + rating badges

[LANGUAGE TRUST BAR]
- "Serving clients in 12+ languages"
- Flag icons

[SERVICE PATHWAY CARDS: 3-4 columns]
- Family Immigration
- Work Visas
- Deportation Defense
- Citizenship
...
[FINAL CTA]
- "Take the First Step"
- Multiple contact options (phone, form, WhatsApp)
...
- Culturally appropriate imagery per language
...
- Simplified visa category navigation
...
4. Testimonial format (video vs. text)
...
- **Gold/Amber**: Warmth, premium service
...
- Document imagery (passports, cards) for context
