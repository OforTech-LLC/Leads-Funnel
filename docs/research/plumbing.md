# Plumbing Landing Page Patterns Research
...
6. **Plumbworx LLC** - Real-world example cited for strong hero section
7. **Splashfix Plumbing** - Real-world example cited for combining trust and urgency
8. **Pimlico Plumbers** - Real-world example cited for clear CTAs and social proof
9. **Roto-Rooter** - Real-world example using reliability as USP ("75+ years trusted")
10. **RooterMan** - Real-world example using video content effectively
...
- **Urgency-Based**: "Emergency Plumbing? We're Available 24/7"
...
4. **Mid-page** - After social proof section
...
- White space around CTA to draw attention
...
2. Phone Number
3. Email
4. Service Type (dropdown: Drain Cleaning, Leak Repair, Water Heater, Emergency, Other)
...
1. **Hero Section**
   ...
   - Hero image (team or technician at work)
   - Trust bar (ratings, license #, years in business)

2. **Emergency Services Banner** (Optional)
...
3. **Services Section**
   ...
   - Drain cleaning, leak repair, water heaters, etc.
...
8. **FAQ Section**
   ...
   - Address pricing, timing, emergency concerns
...
3. Services Grid
4. Why Choose Us (3-4 value props)
...
4. **Local**: City name in headline, service area emphasis
5. **Risk Reversal**: Free estimates, satisfaction guarantee
