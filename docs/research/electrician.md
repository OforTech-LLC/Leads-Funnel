# Electrician Landing Page Patterns Research
...
- **Availability**: "Licensed Electricians Available 24/7"
...
4. **Near testimonials** - After trust is built
...
- Action verb first
- Consider adding phone icon for call CTAs
...
2. Phone Number
3. Email
4. Service Type (Outlet/Switch, Panel Upgrade, Lighting, Emergency, Inspection, Other)
5. Brief Description
...
- Generator brand authorizations
...
1. **Hero Section**
   ...
   - Primary CTA
   - Hero image
   - Trust bar (license, ratings, years in business)

2. **Emergency Services Banner** (if applicable)
   - 24/7 availability
...
3. **Services Section**
   ...
   - Specialty services (EV chargers, smart home, generators)
...
5. **Testimonials/Reviews**
   - Customer review carousel or grid
...
6. **Service Areas**
   - Map or city list
   - Arrange testimonials by service area (like O.J. Mann example)
...
8. **FAQ Section**
   ...
   - Focus on safety, pricing, qualifications
...
3. Services Grid
4. Why Choose Us (safety, licensing, experience)
5. Testimonials/Reviews (with ratings)
...
4. **Transparency**: Upfront pricing, free estimates
5. **Local**: City name in headline, service area emphasis
...
- Display safety certifications prominently
