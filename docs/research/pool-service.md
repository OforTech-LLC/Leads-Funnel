# Pool Service Landing Page Patterns Research
...
- **Local**: "[City]'s Most Trusted Pool Service Company"
...
4. **After testimonials** - Trust-reinforced CTA
5. **Sticky mobile bar** - Always accessible
...
2. Phone Number
3. Email
4. Service Type (Weekly Cleaning, Repair, Equipment, Pool Opening/Closing)
...
4. Address/Zip Code
5. Pool Type
6. Pool Size (approximate)
7. Current Issue/Service Needed
...
- APSP (Association of Pool & Spa Professionals) member
...
- Price lock guarantee for recurring service
...
1. **Hero Section**
   ...
   - Primary CTA
   - Hero image (sparkling pool)
   - Trust bar (ratings, years in business, license)

2. **Services Section**
   - Service cards with icons
   - Weekly cleaning, repairs, equipment, seasonal
   - Brief descriptions

3. **Pricing/Plans Section** (Important for pool service)
   - Tiered pricing plans
   - Weekly vs. bi-weekly options
...
5. **How It Works**
   ...
   - Sign up > Schedule > Service > Enjoy
   - What to expect on service day

6. **Gallery Section**
   - Before/after cleaning photos
   - Pool designs/builds if applicable
   - Equipment installations

7. **Testimonials/Reviews**
   - Customer reviews
   - Star ratings display
   - Specific mentions of service quality
...
9. **FAQ Section**
   ...
   - Pricing, scheduling, service questions
...
- Can you fix pool equipment?
- Do you service above-ground pools?
- What if I have an algae problem?
- Do you offer pool opening/closing services?
...
4. **Visual**: Before/after photos, sparkling pool imagery
5. **Local**: City name, neighborhood service areas
